...
Usage: 'name: "{{- template "library.fullname" . -}}"'
*/ -}}
...
{{- /*
library.fullname.unique adds a random suffix to the unique name.
This takes the same parameters as library.fullname
*/ -}}
{{- define "library.fullname.unique" -}}
  {{ template "library.fullname" . }}-{{ randAlphaNum 7 | lower }}
{{- end }}
